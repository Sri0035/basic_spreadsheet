...
const SecondTable = () => {
  return (
    <>
      <div className="another-table-container table2">
        <Table celled className="custom-table">
          ...
          <Table.Body>
            <Table.Row>
              ...
              <Table.Cell className="hover-function">
                10,000,000-25,000,000
                {/* <Label className="hide">YoY and QoQ</Label> */}
              </Table.Cell>
            </Table.Row>
            <Table.Row>
...
const TwoTables = () => {
  return (
    <>
      <div className="another-table-container table1">
        <div class="info-container">
          <button class="info-button">i</button>
          <div class="info-tooltip">
            This is some additional information about the button.
          </div>
        </div>
        <Table celled className=" ui custom-table">
          <Table.Header>
            <Table.Row>
